...
```
В результате создается новый указатель на текущий коммит. Или простыми словами мы создаем копию текущего коммита в новой ветке, изменения в которой не будут влиять на основную ветку `master` (до слияния).
