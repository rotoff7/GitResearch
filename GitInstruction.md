...
Если вы захотите потренироваться использовать команды и возможности Git в более интересном формате, то это можно сделать на [данном тренажере](https://learngitbranching.js.org/?locale=ru_RU).

***
Данный текст написан с целью искусственно создать конфликт и решить его, ибо в процессе работы, несмотря на то, что я комбинировал несколько разных веток, их не возникало.